...
//É esperado que se encontrar uma pessoa pelo nome, retorne todas as informações dessa pessoa
...
//    }
    ...
    public static void main(String[] args) {
        ...
        //se você colocar um BreakPoint na próxima linha, der o play especial (debug ou depurar o projeto), parar o mouse sobre a palavra início, e for clicando nos +, poderá ver toda a lista em memória.
        mostra(inicio);
